...
public class MinimumPassesMatrix {
    ...
    // positive and store them on a second queue (next); increment the number of passes by 1.
    ...
    private int convertNegativesUsingTwoQueues(int[][] matrix) {
    ...
    private Queue<int[]> getAllPositivePositions(int[][] matrix) {
    ...
    private List<int[]> getAdjacentPositions(int row, int col, int[][] matrix) {
    ...
    private int convertNegativesUsingOneQueue(int[][] matrix) {
