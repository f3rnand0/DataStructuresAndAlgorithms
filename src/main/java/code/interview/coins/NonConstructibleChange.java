...
public class NonConstructibleChange {
    ...
    // Ordering the array helps to define the minimum amount of change that can't be created.
    ...
    // 1.- The coin value is greater than the amount of change that can be currently created plus
